...
// #endif
//
//                 this.m_ThreadIndex = 0; // in case of use of main thread
...
//                     {
//                         this.BeginForEachIndex(this.m_ThreadIndex);
//                     }
//
...
//             private void BeginForEachIndex(int foreachIndex)
//             {
...
//                 }
//
//                 if (this.m_Writer.m_BlockStream->Ranges[foreachIndex].ElementCount != 0)
//                 {
